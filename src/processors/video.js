...
export async function brandVideo({
  ...
  console.log(`[video.js] Branding: logo=${hasLogo} (${logoSize}/${targetHeight}px), header=${brandName || "none"}, footer=${hasFooter ? footerText.slice(0, 60) : "none"}`);
  ...
  // Header: 40px bar, font 18px → visually centered at y=11
  if (hasHeader) {
